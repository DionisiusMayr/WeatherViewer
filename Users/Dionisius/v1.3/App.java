...
public class App {
    public static void main(String [] args) throws IOException, JSONException {
        ...
        System.out.println("Weather Id: \t\t\t" + weatherJSONObject.optString("id", null));
        System.out.println("Weather Icon: \t\t\t" + weatherJSONObject.optString("icon", null));
        System.out.println("Weather Description: \t" + weatherJSONObject.optString("description", null));
        System.out.println("Weather Main: \t\t\t" + weatherJSONObject.optString("main", null));
