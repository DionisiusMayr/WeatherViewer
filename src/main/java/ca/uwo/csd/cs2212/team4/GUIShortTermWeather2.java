...
public class GUIShortTermWeather2 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GUIShortTermWeather2 frame = new GUIShortTermWeather2("london");
	 ...
	 * Create the frame.
	 */
	public GUIShortTermWeather2(String location) {
		this.city = location;
		...
		lblNewLabel_2.setBounds(19, 13, 84, 14);
		contentPane.add(lblNewLabel_2);
		
		txtLondonOnt = new JTextField();
		txtLondonOnt.setBounds(108, 10, 86, 20);
		txtLondonOnt.setText(location);
		contentPane.add(txtLondonOnt);
		txtLondonOnt.setColumns(10);
		
		CustomLabel lblUpdated = new CustomLabel("Updated:");
		lblUpdated.setBounds(199, 13, 45, 14);
		contentPane.add(lblUpdated);
		
		CustomLabel lblNow = new CustomLabel("\"time\"");
		lblNow.setBounds(249, 13, 28, 14);
